        ...
        <View style={styles.container}>
          <View style={styles.contentShiftUp}>
            ...
            <View style={styles.formContentShiftUp}>
              ...
              <View
                style={[styles.inputRow, emailEmpty && styles.inputRowError]}
              >
                <Mail
                  size={20}
                  color={emailEmpty ? colors.danger : INPUT_MUTED}
                  strokeWidth={2}
                />
                <TextInput
                  ...
                  placeholderTextColor={
                    emailEmpty ? colors.danger : INPUT_MUTED
                  }
                  value={email}
                  onChangeText={(v) => {
                    setEmail(v);
              ...
              <View
                style={[styles.inputRow, passwordEmpty && styles.inputRowError]}
              >
                <Lock
                  size={20}
                  color={passwordEmpty ? colors.danger : INPUT_MUTED}
                  strokeWidth={2}
                />
                <TextInput
                  style={styles.inputField}
                  ...
                  placeholderTextColor={
                    passwordEmpty ? colors.danger : INPUT_MUTED
                  }
                  value={password}
                  onChangeText={(v) => {
                    setPassword(v);
                ...
                >
                  {config.buttonVariant === "apple-native" ? (
                    <AppleAuthentication.AppleAuthenticationButton
                      ...
                      onPress={() =>
                        handleSocialSignIn(config.provider, config.label)
                      }
                    />
                  ) : null}
